      ...
      <div className="flexColStart paddings innerWidth property-container">
        ...
        <div className="flexCenter property-details">
          <div className="flexColStart left">
            ...
            <div className="flexStart" style={{ gap: "0.2rem" }}>
              <MdLocationPin size={25} />
              <span className="secondaryText address">{data?.address},</span>
              <span className="secondaryText address">{data?.city},</span>
              <span className="secondaryText address">{data?.country}</span>
            </div>
            ...
            {/* {bookings?.map((booking) => booking.id).includes(id) ? (
              <>
                ...
                <span>
                  You have already booked this place for{" "}
